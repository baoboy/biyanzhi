...
import com.biyanzhi.task.TiaoZhanPKTask;
...
public class TiaoZhanPKSelectPictureActivity extends BaseActivity {
					...
					public void onclick(int position) {
						...
						case 0:
							Utils.showBigPicture(mLists.get(item_position)
									...
									TiaoZhanPKSelectPictureActivity.this);
							break;
						case 1:
	...
	private void addPK(PK1 pk1) {
		showDialog();
		TiaoZhanPKTask task = new TiaoZhanPKTask();
	...
	private void tiaoZhanPrompt() {
		PromptDialog.Builder dialog = DialogUtil.confirmDialog(this,
				"已经向TA发起了PK挑战,请等候TA的回应", "确定", null, new ConfirmDialog() {
