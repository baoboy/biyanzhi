 ...
 * {@link ScrollViewGridViewWithHeaderAndFooter#addHeaderView(View, Object, boolean)}
 * See
 * {@link ScrollViewGridViewWithHeaderAndFooter#addFooterView(View, Object, boolean)}
 */
public class ScrollViewGridViewWithHeaderAndFooter extends GridView {
	...
	public ScrollViewGridViewWithHeaderAndFooter(Context context) {
		super(context);
		initHeaderGridView();
	}
	...
	public void hideFootView() {
		...
		for (int i = 0; i < len; ++i) {
			...
			info.view.setVisibility(View.INVISIBLE);
	...
	private class FullWidthFixedViewLayout extends FrameLayout {
		...
		protected void onLayout(boolean changed, int left, int top, int right,
				int bottom) {
			int realLeft = ScrollViewGridViewWithHeaderAndFooter.this
		...
		protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
			int targetWidth = ScrollViewGridViewWithHeaderAndFooter.this
					.getMeasuredWidth()
					- ScrollViewGridViewWithHeaderAndFooter.this
							.getPaddingLeft()
					- ScrollViewGridViewWithHeaderAndFooter.this
							.getPaddingRight();
