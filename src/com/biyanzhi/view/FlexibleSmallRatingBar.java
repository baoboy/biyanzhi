...
public class FlexibleSmallRatingBar extends RatingBar {
	...
	public FlexibleSmallRatingBar(Context context) {
		this(context, null);
	}

	public FlexibleSmallRatingBar(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected synchronized void onMeasure(int widthMeasureSpec,
		...
		int desiredWidth = (int) (22 * dp * getNumStars());
