...
public class PicturePaser implements IParser {

	@Override
	public Result<Picture> parse(JSONObject jsonObj) throws Exception {
		if (jsonObj == null) {
			return Result.defContentErrorResult();
		}
		JSONObject obj = jsonObj.getJSONObject("picture");
		...
		Result<Picture> ret = new Result<Picture>();
		ret.setData(picture);
		return ret;
	}
